...
public class ParkingSpacesServiceTest {
    ...
    class ShouldListParkingSpacesByStatus{
        ...
        public void itShouldReturnOnlyAvailableParkingSpaces(){
            //Given
            ParkingSpace parkingSpace1 = new ParkingSpace(Long.valueOf(2), null, null, AVAILABLE, null);
            ParkingSpace parkingSpace2 = new ParkingSpace(Long.valueOf(3), null , null, AVAILABLE, null);
